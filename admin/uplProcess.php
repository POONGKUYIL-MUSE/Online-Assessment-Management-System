    ...
    if($FileType != "xlsx") {
      echo "Sorry, only xlsx files are allowed. ".$FileType." is your uploaded file type ... ".$_FILES['uplfile']['tmp_name']." is the name of the file";
        ...
        if(!(file_exists($qname))){
            ...
            $reader = \PhpOffice\PhpSpreadsheet\IOFactory::load($exfile);
            ...
            if(file_put_contents($qname,$final,FILE_APPEND)){
                ...
                //echo $qname;
                $qsql = "INSERT INTO quizzes(quizname,type,status, tqnos,qnos,timing,attmpt,crdate) VALUES ('$filedb', '$qtype', '$qstatus', '$count', '$qno', '$timing', '0', NOW())";
